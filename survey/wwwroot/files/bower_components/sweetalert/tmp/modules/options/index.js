...
var pickButtonParam = function (opts) {
    ...
    if (singleButton !== undefined && buttonList !== undefined) {
        (0, utils_1.throwErr)("Cannot set both 'button' and 'buttons' options!");
    }
...
// Example 0 -> 1st
var indexToOrdinal = function (index) { return (0, utils_1.ordinalSuffixOf)(index + 1); };
var invalidParam = function (param, index) {
    (0, utils_1.throwErr)("".concat(indexToOrdinal(index), " argument ('").concat(param, "') is invalid"));
};
var expectOptionsOrNothingAfter = function (index, allParams) {
    var nextIndex = (index + 1);
    var nextParam = allParams[nextIndex];
    if (!(0, utils_1.isPlainObject)(nextParam) && nextParam !== undefined) {
        (0, utils_1.throwErr)("Expected ".concat(indexToOrdinal(nextIndex), " argument ('").concat(nextParam, "') to be a plain object"));
    }
};
var expectNothingAfter = function (index, allParams) {
    ...
    if (nextParam !== undefined) {
        (0, utils_1.throwErr)("Unexpected ".concat(indexToOrdinal(nextIndex), " argument (").concat(nextParam, ")"));
    }
};
/*
...
var paramToOption = function (opts, param, index, allParams) {
    ...
    else if ((0, utils_1.isPlainObject)(param)) {
...
var getOpts = function () {
    ...
    opts.buttons = (0, buttons_1.getButtonListOpts)(buttonListOpts);
    delete opts.button;
    opts.content = (0, content_1.getContentOpts)(opts.content);
    ...
    Object.keys(finalOptions).forEach(function (optionName) {
        if (deprecations_1.DEPRECATED_OPTS[optionName]) {
            (0, deprecations_1.logDeprecation)(optionName);
        }
    });
    return finalOptions;
};
