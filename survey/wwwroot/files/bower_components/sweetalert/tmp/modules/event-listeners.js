...
var onKeyUp = function (e) {
    if (!state_1.default.isOpen)
        return;
    switch (e.key) {
        case "Escape": return (0, actions_1.onAction)(buttons_1.CANCEL_KEY);
    }
};
...
var setFirstButtonFocus = function () {
    var button = (0, utils_1.getNode)(BUTTON);
    if (button) {
        button.tabIndex = 0;
        button.focus();
    }
...
var setLastButtonFocus = function () {
    ...
    var buttons = modal.querySelectorAll(".".concat(BUTTON));
...
var onOutsideClick = function (e) {
    ...
    if (overlay !== e.target)
        return;
    return (0, actions_1.onAction)(buttons_1.CANCEL_KEY);
};
