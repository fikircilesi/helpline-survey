...
var ICON_CONTENTS = {
    error: (0, markup_1.errorIconMarkup)(),
    warning: (0, markup_1.warningIconMarkup)(),
    success: (0, markup_1.successIconMarkup)(),
};
/*
...
var initIcon = function (str) {
    if (!str)
        return;
    var iconEl = (0, modal_1.injectElIntoModal)(markup_1.iconMarkup);
