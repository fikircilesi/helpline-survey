...
var addInputEvents = function (input) {
    input.addEventListener('input', function (e) {
        ...
        (0, state_1.setActionValue)(text);
    });
    input.addEventListener('keyup', function (e) {
        if (e.key === "Enter") {
            return (0, actions_1.onAction)(buttons_1.CONFIRM_KEY);
        }
    });
    /*
    ...
    setTimeout(function () {
        input.focus();
        (0, state_1.setActionValue)('');
    }, 0);
};
var initPredefinedContent = function (content, elName, attrs) {
    var el = document.createElement(elName);
    var elClass = "".concat(CONTENT, "__").concat(elName);
...
var initContent = function (opts) {
    if (!opts)
        return;
    var content = (0, modal_1.injectElIntoModal)(markup_1.contentMarkup);
