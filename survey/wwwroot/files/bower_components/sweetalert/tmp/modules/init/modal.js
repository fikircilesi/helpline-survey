...
var injectElIntoModal = function (markup) {
    ...
    var el = (0, utils_1.stringToNode)(markup);
...
var initModalContent = function (opts) {
    ...
    (0, icon_1.default)(opts.icon);
    (0, text_1.initTitle)(opts.title);
    (0, text_1.initText)(opts.text);
    (0, content_1.default)(opts.content);
    (0, buttons_1.default)(opts.buttons, opts.dangerMode);
};
exports.initModalContent = initModalContent;
var initModalOnce = function () {
    var overlay = (0, utils_1.getNode)(OVERLAY);
    var modal = (0, utils_1.stringToNode)(markup_1.modalMarkup);
