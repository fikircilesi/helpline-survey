...
var getButton = function (namespace, _a, dangerMode) {
    ...
    var buttonContainer = (0, utils_1.stringToNode)(markup_1.buttonMarkup);
    var buttonEl = buttonContainer.querySelector(".".concat(BUTTON));
    var btnNamespaceClass = "".concat(BUTTON, "--").concat(namespace);
    ...
    (0, state_1.setActionValue)(actionValues);
    (0, state_1.setActionOptionsFor)(namespace, {
        closeModal: closeModal,
    });
    buttonEl.addEventListener('click', function () {
        return (0, actions_1.onAction)(namespace);
    });
...
var initButtons = function (buttons, dangerMode) {
    var footerEl = (0, modal_1.injectElIntoModal)(markup_1.footerMarkup);
